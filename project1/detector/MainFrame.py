...
from project1.detector.MainUI import Ui_MainWindow
from project1.detector.carFrame import CarFrame
from project1.detector.peopleFrame import PeopleFrame
